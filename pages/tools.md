#### [←home](../README.md)
 ...
 I have built a few simple programs either in school/home to help me understand a little better the physics and the programming language itself (Java). 
...
<div style="text-align: justify">
A model of a pipeline, involving the transport of oil through permafrost. The problem was proposed in my applied Adv. Heat Transfer Class (2014).  The goal was to provide a stand-alone tool that can display flow input and output parameters, as well as varying pipe and insulation diameters. It used integration and closed formulas to attain solution.
</div><br/>
